...
public class tienda extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("cual es la ganancia hasta el cierre");
        ...
        jLabel2.setText("total compra de clientes");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(ganancia, javax.swing.GroupLayout.DEFAULT_SIZE, 207, Short.MAX_VALUE)
                            .addComponent(total)
                            .addComponent(Gtotal)))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(259, 259, 259)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
      float cliente=0, venta, compra;
      for (int i=0; i<15; i++){
          cliente = cliente + Integer.parseInt(JOptionPane.showInputDialog("ingrrese un numerp "));
          
      }
      total.setText(String.valueOf(cliente));
      venta= Float.parseFloat(ganancia.getText());
      compra= cliente + venta; 
      Gtotal.setText(String.valueOf(compra));
